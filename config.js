...
if (!(process.env.SESSION || process.envRaganork~2d0747bf80f64ccf6d61a4c8d6acd397:384e423539486939672b773dD)) throw new Error("No session found, add session before starting bot")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923167441892@g.us',
    ...
    RG: process.env.RG || '923167441892@g.us,923167441892@g.us',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "ayaan",
    BOT_NAME: process.env.BOT_NAME || 'LoveFucker',
